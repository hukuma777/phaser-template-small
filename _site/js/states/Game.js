...
MyGame.Game.prototype = {
    ...
    create: function() {
        ...
        for(let i=0; i<100; i++){
            this.starCount++;
            let star = this.stars.create(this.rnd.integerInRange(80,560),
    ...
    // 物理エンジンをdudeが使う
    // ARCADEb物理エンジン＝簡易なもの。速度が速い
    this.physics.arcade.enable(this.dude);


    //物理エンジンを有効にするとbodyというプロパティーが使えるようになる
...
// 星とった時の処理
    ...
    // 更新処理
    update: function() {
        //dudeと星が重なったら、その星を消す処理（PｃｋStar）を呼び出す
        this.physics.arcade.overlap(
                this.dude, this.stars, this.pickStar, null, this);
